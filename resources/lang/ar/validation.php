...
return [
    'custom' => [
        ...
        'type_controller' => [
            'id_required' => 'معرف النوع مطلوب.',
            'id_exists' => 'النوع المحدد غير موجود.',
            'not_found' => 'النوع المطلوب غير موجود.',
            'name_exists' => 'يوجد نوع بنفس الاسم في هذه الخدمة.',
            'created' => 'تم إنشاء النوع بنجاح.',
            'deleted' => 'تم حذف النوع بنجاح.',
            'already_delete' => 'هذا النوع محذوف بالفعل.',
        ],
        'service-' => [
            'id_required' => 'معرف الخدمة مطلوب.',
            'id_exists' => 'الخدمة المحددة غير موجودة.',
        ],
        'form' => [
            'id_required' => 'معرف النموذج مطلوب.',
            'id_exists' => 'النموذج المحدد غير موجود.',
        ],
