...
return [
    'custom' => [
        ...
        'type_controller' => [
            ...
            'name_en_max' => 'يجب ألا يتجاوز الاسم باللغة الإنجليزية :max حرفًا.',
            'name_en_unique' => 'الاسم باللغة الإنجليزية يجب أن يكون فريدًا.',

            'name_ar_required' => 'الاسم باللغة العربية مطلوب.',
            'name_ar_max' => 'يجب ألا يتجاوز الاسم باللغة العربية :max حرفًا.',
            'name_ar_unique' => 'الاسم باللغة العربية يجب أن يكون فريدًا.',

            'service_id_required' => 'معرّف الخدمة مطلوب.',
            'service_id_exists' => 'معرّف الخدمة المحدد غير صالح.',

            'form_id_required' => 'معرّف النموذج مطلوب.',
            'form_id_exists' => 'معرّف النموذج المحدد غير صالح.',

            'id_required' => 'معرّف النوع مطلوب.',
            'id_exists' => 'معرّف النوع المحدد غير صالح.',

            'created' => 'تم إنشاء النوع بنجاح.',
            'updated' => 'تم تحديث النوع بنجاح.',
            'not_found' => 'لم يتم العثور على النوع المطلوب.',
        ],
